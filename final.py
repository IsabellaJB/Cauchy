...
# Golden Search con Cauchy
opt_golden = GoldenSearch(funcion_objetivo, epsilon=0.001, a=0.1, b=0.0)
opt_cauchy_golden = Cauchy([0, 0], funcion_objetivo, epsilon1=0.001, epsilon2=0.001, M=100, metodo_univariable=opt_golden)
resultado_cauchy_golden = opt_cauchy_golden.optimizar()
print("Resultado Cauchy con Golden Search:", resultado_cauchy_golden)

# Fibonacci con Cauchy
opt_fibonacci = Fibonacci(funcion_objetivo, epsilon=0.001)
opt_cauchy_fibonacci = Cauchy([0, 0], funcion_objetivo, epsilon1=0.001, epsilon2=0.001, M=100, metodo_univariable=opt_fibonacci)
resultado_cauchy_fibonacci = opt_cauchy_fibonacci.optimizar()
print("Resultado Cauchy con Fibonacci:", resultado_cauchy_fibonacci)
